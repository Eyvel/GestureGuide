...
public class ContentActivity extends AppCompatActivity {
    ...
    private void fetchContent(String categoryId) {
        String url = "http://192.168.8.9/gesture/getContent.php?category_id=" + categoryId;  // Adjust URL as needed
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                String imageUrl = "http://192.168.8.9/" + contentImage;
                                String videoUrl = "http://192.168.8.9/" + contentVideo;
